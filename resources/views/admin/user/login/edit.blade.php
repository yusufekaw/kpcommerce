...
@endphp
<form method="post" action="{{ url('admin/useradmin/update/'.$useradmin->id_user) }}" enctype="multipart/form-data">
  @csrf
    ...
    <div class="x_panel">
      ...
      <div class="x_content">
        <div class="form-group">
          ...
          <div class="col-md-8">
            <input type="text" name="nama_depan" id="nama_depan" value="{{ $useradmin->nama_depan }}" required="required" class="form-control col-md-8 col-sm-12">
            @error('nama_depan')
        ...
        <div class="form-group">
          ...
          <div class="col-md-8">
            <input type="text" id="nama_belakang" name="nama_belakang" value="{{ $useradmin->nama_belakang }}" required="required" class="form-control col-md-8 col-sm-12">
            @error('nama_belakang')
            <span class="text text-danger">{{ $message }}</span>
            @enderror
          </div>
        ...
        <div class="form-group">
          ...
          <div class="col-md-8">
            <input type="email" id="email" name="email" value="{{ $useradmin->email }}" required="required" class="form-control col-md-8 col-sm-12">
            @error('email')
            <span class="text text-danger">{{ $message }}</span>
            @enderror
          </div>
